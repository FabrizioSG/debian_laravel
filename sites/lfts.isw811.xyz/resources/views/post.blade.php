            ...
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                ...
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                    ...
                    <form method="POST" action="/posts/{{ $post->slug }}/comments" class="border border-gray-200 p-6 rounded-xl">
                        ...
                        <div class="mt-6">
                            <textarea name="body" class="w-full" cols="30" rows="5" placeholder="Post your comment here!"></textarea>
                        </div>
                        <div class="flex justify-end mt-10 border-t border-gray-200 mt-6">
                            <button type="submit" class="bg-blue-500 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-600 mt-2">
                                Post
                            </button>
                        </div>
                    </form>
